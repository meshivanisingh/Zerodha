...
function Footer() {
  return (
    ...
    <div className="container border-top mt-5">
      ...
      <div  >
      <a href="#" className="text-muted" style={{textDecoration:"none", margin:"10px", fontSize:"14px"}}>NSE</a>
      <a herf="#" className="text-muted" style={{textDecoration:"none", margin:"10px", fontSize:"14px"}}>BSE</a>
      <a herf="#" className="text-muted" style={{textDecoration:"none", margin:"10px", fontSize:"14px"}}>MCX</a> 
      <a herf="#" className="text-muted" style={{textDecoration:"none", margin:"10px", fontSize:"14px"}}>Terms & conditions</a>
      <a herf="#" className="text-muted" style={{textDecoration:"none", margin:"10px", fontSize:"14px"}}>Policies & procedures</a> 
      <a herf="#" className="text-muted" style={{textDecoration:"none", margin:"10px", fontSize:"14px"}}>Privacy policy</a> 
      <a herf="#" className="text-muted" style={{textDecoration:"none", margin:"10px", fontSize:"14px"}}>Disclosure</a> 
      <a herf="#" className="text-muted" style={{textDecoration:"none", margin:"10px", fontSize:"14px"}}>For investor's attention</a> 
      <a herf="#" className="text-muted" style={{textDecoration:"none", margin:"10px", fontSize:"14px"}}>Investor charter</a>
      </div>
    </div>
    </footer>
  )
